...
## Welcome to Eon Collective's dbt-coalasce-simple-project

<p align="center">

[![Deploy to Environment](https://github.com/eon-collective/dbt-coalasce-simple-project/actions/workflows/deploy-coalesce.yml/badge.svg)](https://github.com/eon-collective/dbt-coalasce-simple-project/actions/workflows/deploy-coalesce.yml)

</p>
# Welcome to db fundamental course.
...
# Versions <a name="versions-" id="versions-"></a> [↑](#toc-)

## Revision History <a name="project_revisionhistory" id="project_revisionhistory"></a> [↑](#toc-)

|**Version** | **Revision Date** |
| :-------: | :-------------: |
|v1.0.0       | May 10, 2023    |

## dbt Project Version <a name="dbt_project_version_info" id="dbt_project_version_info"></a> [↑](#toc-)
...
# Overview <a name="dbt_project_overview" id="dbt_project_overview"></a> [↑](#toc-)

The purpose for this project, is to have an understanding of how coalesce works. I got to understand how the different concepts and principles work in dbt. Below are the major things I have learnt:

- Setting up dbt on Cloud.
- Models.
- Sources.
- Writing dbt tests.
- DBT Deployment.
...
[↑](#toc-)
# Application Functional Overview <a name="dbt_project_components" id="dbt_project_components"></a> 

Here, I have outlined a high level architecture of how my project will be working end to end.
...
[↑](#toc-)
###  Source Data from Raw Layer  <a name="dbt_project_input_source_tables" id="dbt_project_input_source_tables"></a>
...
[↑](#toc-)
###  Static/Seeds <a name="dbt_project_input_static_or_seeds" id = "dbt_project_input_static_or_seeds"></a>

The following static tables are used by this project. Non-seed files are located in the 
'seeds/employee.csv' folder. They get `COPY INTO` the appropriate tables using a storage integration.

| **FILENAME**       | **DATABASE** | **SCHEMA**   | **SEED**  | **NOTES**                                                                                                                 |
|--------------------|--------------|--------------|-----------|---------------------------------------------------------------------------------------------------------------------------|
| seeds/employee.csv | ANALYTICS    | DBT_GGITHIRI | EMPLOYEES | Loaded with `dbt seed` command run - loads static csv file found in the `data` folder of the project into snowflake table |



[↑](#toc-)
## Cleansing/Transformation <a name="dbt_project_cleansing_and_transformation" id ="dbt_project_cleansing_and_transformation"></a>
...
|--------------|--------------|------------------------------------------------|---------------------|----------|-----------|
| ANALYTICS    | DBT_GGITHIRI | DIM_CUSTOMERS                                  | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_ORDERS                                     | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | INT_ORDERS__PIVOTED                            | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_CUSTOMERS                                  | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_ORDERS                                     | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_PAYMENTS                                   | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | DIM_DBT__CURRENT_MODELS                        | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | DIM_DBT__EXPOSURES                             | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | DIM_DBT__MODELS                                | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | DIM_DBT__SEEDS                                 | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | DIM_DBT__SNAPSHOTS                             | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | DIM_DBT__SOURCES                               | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | DIM_DBT__TESTS                                 | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_DBT__INVOCATIONS                           | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_DBT__MODEL_EXECUTIONS                      | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_DBT__MODEL_INFORMATION                     | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_DBT__SEED_EXECUTIONS                       | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_DBT__SNAPSHOT_EXECUTIONS                   | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_DBT__TEST_EXECUTIONS                       | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | EXPOSURES                                      | INCREMENTAL         | []       |           |
| ANALYTICS    | DBT_GGITHIRI | INVOCATIONS                                    | INCREMENTAL         | []       |           |
| ANALYTICS    | DBT_GGITHIRI | MODELS                                         | INCREMENTAL         | []       |           |
| ANALYTICS    | DBT_GGITHIRI | MODEL_EXECUTIONS                               | INCREMENTAL         | []       |           |
| ANALYTICS    | DBT_GGITHIRI | MODEL_INFORMATION                              | INCREMENTAL         | []       |           |
| ANALYTICS    | DBT_GGITHIRI | SEEDS                                          | INCREMENTAL         | []       |           |
| ANALYTICS    | DBT_GGITHIRI | SEED_EXECUTIONS                                | INCREMENTAL         | []       |           |
| ANALYTICS    | DBT_GGITHIRI | SNAPSHOTS                                      | INCREMENTAL         | []       |           |
| ANALYTICS    | DBT_GGITHIRI | SNAPSHOT_EXECUTIONS                            | INCREMENTAL         | []       |           |
| ANALYTICS    | DBT_GGITHIRI | SOURCES                                        | INCREMENTAL         | []       |           |
| ANALYTICS    | DBT_GGITHIRI | TESTS                                          | INCREMENTAL         | []       |           |
| ANALYTICS    | DBT_GGITHIRI | TEST_EXECUTIONS                                | INCREMENTAL         | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_DBT__EXPOSURES                             | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_DBT__INVOCATIONS                           | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_DBT__MODELS                                | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_DBT__MODEL_EXECUTIONS                      | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_DBT__MODEL_INFORMATION                     | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_DBT__SEEDS                                 | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_DBT__SEED_EXECUTIONS                       | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_DBT__SNAPSHOTS                             | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_DBT__SNAPSHOT_EXECUTIONS                   | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_DBT__SOURCES                               | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_DBT__TESTS                                 | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_DBT__TEST_EXECUTIONS                       | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | INT_ALL_DAG_RELATIONSHIPS                      | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | INT_ALL_GRAPH_RESOURCES                        | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | INT_DIRECT_RELATIONSHIPS                       | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_DIRECT_JOIN_TO_SOURCE                      | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_DUPLICATE_SOURCES                          | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_HARD_CODED_REFERENCES                      | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_MARTS_OR_INTERMEDIATE_DEPENDENT_ON_SOURCE  | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_MULTIPLE_SOURCES_JOINED                    | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_REJOINING_OF_UPSTREAM_CONCEPTS             | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_ROOT_MODELS                                | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_SOURCE_FANOUT                              | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_STAGING_DEPENDENT_ON_MARTS_OR_INTERMEDIATE | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_STAGING_DEPENDENT_ON_STAGING               | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_UNUSED_SOURCES                             | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_DOCUMENTATION_COVERAGE                     | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_UNDOCUMENTED_MODELS                        | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_CHAINED_VIEWS_DEPENDENCIES                 | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_EXPOSURE_PARENTS_MATERIALIZATIONS          | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_MODEL_DIRECTORIES                          | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_MODEL_NAMING_CONVENTIONS                   | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_SOURCE_DIRECTORIES                         | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | FCT_TEST_DIRECTORIES                           | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_EXPOSURES                                  | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_EXPOSURE_RELATIONSHIPS                     | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_METRICS                                    | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_METRIC_RELATIONSHIPS                       | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_NODES                                      | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_NODE_RELATIONSHIPS                         | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_SOURCES                                    | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | BASE_EXPOSURE_RELATIONSHIPS                    | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | BASE_METRIC_RELATIONSHIPS                      | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | BASE_NODE_RELATIONSHIPS                        | TABLE               | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_NAMING_CONVENTION_FOLDERS                  | VIEW                | []       |           |
| ANALYTICS    | DBT_GGITHIRI | STG_NAMING_CONVENTION_PREFIXES                 | VIEW                | []       |           |
...
|--------------|---------------------|----------------------------|
| DBT_GGITHIRI | DIM_CUSTOMERS       | VIEW                       |
| DBT_GGITHIRI | FCT_ORDERS          | VIEW                       |
| DBT_GGITHIRI | INT_ORDERS__PIVOTED | VIEW                       |
| DBT_GGITHIRI | STG_CUSTOMERS       | VIEW                       |
| DBT_GGITHIRI | STG_ORDERS          | VIEW                       |
| DBT_GGITHIRI | STG_PAGE_VIEWS      | INCREMENTAL                |
| DBT_GGITHIRI | STG_PAYMENTS        | VIEW                       |
| DBT_GGITHIRI | ALL_DATES           | TABLE                      |                                                  |
...
**DBT fundamentals Data Lineage**

![Scheme](etc/dbt-dag.png "UMM_EMEA_STAGE Data Lineage")
...
3. Clone this repository
    ...
    ```console
    $ git clone https://github.com/eon-collective/dbt-fundamental-course.git
    ```

4. Change into the `dbt_project_template` directory from the command line:
    ```console
    $ cd dbt-fundamental-course
    ```
